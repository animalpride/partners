  ...
  return (
    <main className="coming-soon-shell" aria-live="polite">
      ...
      <section className="coming-soon-card">
        <img src="/AnimalPridePartnerLogotrans.png" alt="Animal Pride Partners" className="coming-soon-logo" />
        ...
        <Typography.Paragraph className="coming-soon-message">{message || DEFAULT_MESSAGE}</Typography.Paragraph>
        <Typography.Paragraph className="coming-soon-meta">
          We are rebuilding key workflows and content to make partner operations faster, clearer, and more reliable.
        </Typography.Paragraph>
        <Button type="primary" size="large" href="mailto:partners@animalpride.com">
